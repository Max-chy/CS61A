...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            T0 = 0
            while T0 == 0 or extra_turn(score0, score1) == True:
                T0 += 1
                player0_num = strategy0(score0, score1)
                score0 += take_turn(player0_num, score1, dice)
                say = say(score0, score1)
                if score0 >= goal:
                    return score0, score1
        else:
            T1 = 0
            while T1 == 0 or extra_turn(score1, score0) == True:
                T1 += 1
                player1_num = strategy1(score1, score0)
                score1 += take_turn(player1_num, score0, dice)
                say = say(score0, score1)
                if score1 >= goal:
                    return score0, score1
        who = other(who)
    ...
    def say(score0, score1):
        if who == 0:
            if score0 - last_score > running_high:
                running_high2 = score0 - last_score
                print(running_high2, "point(s)! The most yet for Player", who)
            ...
            if score1 - last_score > running_high:
                running_high2 = score1 - last_score
                print(running_high2, "point(s)! The most yet for Player", who)
